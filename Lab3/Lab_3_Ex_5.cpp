...
// Функция сортировки пузырьком на интервале по убыванию
void bubbleSortRangeDesc(int arr[], int start, int end)
{
...
int main()
{
    ...
    std::cout << "Сортировка по убыванию на интервале индексов [" 
              << N1 << ", " << N2 << "]" << std::endl;
    ...
    // Сортировка на заданном интервале по убыванию
    bubbleSortRangeDesc(mas, N1, N2);
